...
<table border="1">
		...
		<tr><td colspan="2">
				<a href="modifyForm.jsp?cId=<%=commentNo %>"><input type="button" id="btnModify" value="수정" /></a>
				<a href="deleteComment.jsp?cId=<%=commentNo %>"><input type="button" id="btnDelete" value="삭제" /></a>
				</td></tr>
</table>
</body>
</html>